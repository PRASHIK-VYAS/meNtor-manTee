        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration:
                  const InputDecoration(labelText: 'CGPA (till this sem)'),
              keyboardType: TextInputType.number,
            ),
          ],
        ),
          ...
          ElevatedButton(
            onPressed: () {
              final newSemester = semester.copyWith(
                ...
                resultStatus: (double.tryParse(sgpaController.text) ?? 0) > 4.0
                    ? 'Pass'
                    : 'Fail',
              );
              ...
              if (nameController.text.isNotEmpty) {
                try {
                  ...
                  final mark = SubjectMark(
                    ...
                    internal: double.tryParse(internalController.text) ?? 0.0,
                    external: double.tryParse(externalController.text) ?? 0.0,
                  );
